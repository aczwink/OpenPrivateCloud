...
export const resourceProviders =
{
    ...
    fileServices: {
        ...
        objectStorageResourceType: {
            name: c_objectStorageResourceTypeName
        }
    },

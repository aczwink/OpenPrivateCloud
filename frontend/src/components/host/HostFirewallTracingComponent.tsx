...
import { APIResponseHandler, NamedSchemaRegistry, ObjectEditorComponent } from "acfrontendex";

 
@Injectable
export class HostFirewallTracingComponent extends Component
{
    constructor(private apiService: APIService, routerState: RouterState, private apiResponseHandler: APIResponseHandler, private apiSchemaService: NamedSchemaRegistry)
    {
        super();

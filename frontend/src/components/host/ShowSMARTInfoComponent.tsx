...
import { BootstrapIcon, Component, Injectable, JSX_CreateElement, ProgressSpinner, RouterState } from "acfrontend";
    ...
    private RenderStatus(attr: SMART_Attribute): RenderValue
    {
        switch(this.FindAttributeStatus(attr))
        {
            ...
            case AttrStatus.Error:
                return <div className="text-danger"><BootstrapIcon>exclamation-circle-fill</BootstrapIcon></div>;
            case AttrStatus.Warning:
                return <div className="text-warning"><BootstrapIcon>exclamation-diamond</BootstrapIcon></div>;
    ...
    private RenderTests(smartInfo: SMART_Result)
    {
        ...
        return <fragment>
            ...
            <table>
                ...
                {ObjectExtensions.Entries(smartInfo.ata_smart_data.self_test.polling_minutes).Map(kv => <tr>
                    <td>{kv.key}</td>
